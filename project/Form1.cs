...
namespace project
{
    ...
    public partial class Form1 : Form
    {
        ...
        public int jump = 0, s = 0, num, ct_tick = 0, nm, ct = 0, flag2 = 0, con = 0, move3 = 0, flag = 0, gold = 5, move = 0, move2 = 0, drag = 1, gn = 1, zombie = 5, id = 0, fl = -1, r = 0, ff = 0, cc = 0, ic = 15, dr = 0, fe = 0, fee = 0, ctt = 0, x = 0, oy = 0, icc = 0, ox = 0, ib = 0, ooo = 0, zo = 0, gun = 0, l = 1, dmg = 15, zz = 0, f = 0, j = 0, bhp = 0, nhp = 0, a = 0, icee = 3, ice = 3, ee = 0, h = 2, zzz = 0, ei = 20, z = 0, door = 0, c = 0, loser = 0, p = 0, k = 5, pos = 0, d = 0, lk = 0, o = 0;
        Timer tt = new Timer();
        ...
        void Createnar4mal()
        {
            ...
            pnn.img = new Bitmap("nar.bmp");
            pnn.img.MakeTransparent(pnn.img.GetPixel(0, 0));
            pnn.XD = MM[0].XD+40 - MM[0].imgld[ic].Width;
            pnn.YD = MM[0].YD + pnn.img.Height / 2;
            pnn.XS = 0;
            pnn.YS = 0;
            L33.Add(pnn);
        ...
        void Tt_Tick(object sender, EventArgs e)
        {
            ...
            if (flag >= 8 && flag < 20)//5od ymen --andrew meled
            {
                move = 1;
                flag++;
            }

            if (flag == 7) //andrew meled 
            { 
                if(MM[0].YD<Le[0].YD+Le[0].imgld[0].Height)//2af we adrb al gun
                {
                    move = 0;
                    flag = 8;
                }
            }
            if (flag == 6)//mahmoud ibrahim
            {
                if (Le[2].XD-6 < MM[0].XD)//dwr 3la al gun
                {
                    move2 = 0;
                    move3 = 0;
                    move = 2;
            ...
            for(int i=0;i<Lr.Count;i++)//mahmoud ibrahim
            {
                if (MM[0].XD + MM[0].imgld[0].Width + 45 > Lr[i].XD && MM[0].XD + MM[0].imgld[0].Width < Lr[i].XD + Lr[i].img.Width +16 && MM[0].YD+5>Le[0].YD)
                {
                    move2 = 1;
                }
                
            }
             for(int i=0;i<Lboom.Count;i++) //mohamed mortaga
            {
                if (MM[0].XD + MM[0].imgld[0].Width + 45 > Lboom[i].XD && MM[0].XD + MM[0].imgld[0].Width < Lboom[i].XD + Lboom[i].img.Width + MM[0].imgld[0].Width && MM[0].YD - 5 < Lboom[i].YD + Lboom[i].img.Height && MM[0].YD + MM[0].imgld[0].Height > Lboom[i].YD && Lboom[i].YD == L2[0].Y - L2[0].img.Height - 1)
                {
                    move2 = 1;
                }
                
            }
             for (int i = 0; i < bull.Count; i++) //andrew meled
             {
                 if (MM[0].XD + MM[0].imgld[0].Width + 100 > bull[i].XD && MM[0].XD + MM[0].imgld[0].Width < bull[i].XD + bull[i].img.Width + 100 && MM[0].YD + 5 > Le[0].YD )
                 {
                     move2 = 1;
                 }

             }
             if (flag == 4)//kirolos ehab 
            {
             ...
             if (flag == 5)//wsl ll ard - kirolos ehab 
            {
                move2 = 1;
                move = 0;
                move3 = 2;
                ...
                if (dragon.Count == 0)// al drag mat
                {
                    flag = 6;  //kml m4i l7d al asnser ber 3den ro7 y3mn we b3den adrb  we end al game fe al a5er
                }
            }
            ...
            if (move == 2&&d!=2)
            {
                ...
                if (L[0].XS - 1 >= 0)
                {
                    ...
                    for (int i = 0; i < lc.Count; i++)
                    {
                        if (MM[0].XD-50 > lc[i].XD + lc[i].imgld[0].Width && MM[0].XD + MM[0].imgld[ic].Width / 2 < lc[i].XD + lc[i].imgld[0].Width + MM[0].imgld[ic].Width * 3 / 4 && MM[0].YD - MM[0].imgld[ic].Height / 2 <= lc[i].YD && MM[0].YD + MM[0].imgld[ic].Height > lc[i].YD)
                        {
                            lc.RemoveAt(i);
                            door++;
                        }
            ...
            if (dragon.Count != 0)//a2tl dragon
            {
                ...
                for (int i = 0; i < bull.Count; i++)//drag ydrab
                {
                ...
                for (int i = 0; i < bull.Count; i++)//drb al drag
                {
            ...
            if (loser != 3 || loser != 1)
            {
                ...
                if (lud.Count != 0 && gun == 5) //b7to 3la al bar
                {
                ...
                if (loser == 0)
                {
                    ...
                    for (int i = 0; i < Lr.Count; i++)//dmg mn4ar
                    {
            ...
            if (lc.Count == 0 && flag == 0 || lc.Count == 0 && flag == 1 || nm <= 4) //lf l7d lma al zombies temot.--mohamed mortaga
            {
                if (flag == 1)
                {
                    if (nm >= 0 && nm <= 4)
                    {
                        if (Lm[0].XD + Lm[0].imgld[0].Width / 2 > MM[0].XD && MM[0].YD < Lbb[nm].YD)//drba ymen.--mohamed mortaga
                        {
                            move3 = 1;
                            if (L4[1].W > 0)
                            {
                        ...
                        if (Lm[0].XD < MM[0].XD + MM[0].imgld[0].Width / 2 && MM[0].YD < Lbb[nm].YD)//drba 4mal.--mohamed mortaga
                        {
                            move3 = 2;
                            if (L4[1].W > 0)
                            {
                ...
                for (nm = 0; nm < Le.Count; nm++) //lf 3la al elevator.--mohamed mortaga
                {

                    if (Le[nm].XD - Le[nm].imgld[0].Width / 2 <= MM[0].XD && Le[nm].XD + Le[nm].imgld[0].Width / 2 >= MM[0].XD + MM[0].imgld[ic].Width && Le[nm].YD - Le[nm].imgld[0].Height / 2 <= MM[0].YD && Le[nm].YD + Le[nm].imgld[0].Height / 2 >= MM[0].YD || flag == 1)
                    {
                        move = 7;
                        flag = 1;
                        break;
            ...
            if (flag == 2 && lc.Count != 0) //lw mwt zombies take al coin. --mohamed mortaga
                {
                    if (lc[0].XD + lc[0].imgld[0].Width / 2 > MM[0].XD && MM[0].YD < Lbb[0].YD)//coin ymen .
                    {
                        move = 1;
                    }
                    if (lc[0].XD < MM[0].XD + MM[0].imgld[0].Width / 2 && MM[0].YD < Lbb[0].YD)//coin coin 4mal.
                    {
            ...
            if (flag == 0) //lw mfe4 wgha kml ymemn --mohamed mortaga
                {
                    move = 1;
                    move3 = 0;
                    move2 = 0;
                }
                if (flag == 20) //adrb al gun --mohamed mortaga 
                {
                    if (bgun[0].W > 0)
                    {
                        move = 0;
                ...
                if (flag == 21 && MM[0].XD + 100 >= lud[0].XD) //ri7 y end al game  - kirolos ehab 
                {
        ...
        void Createboom()
        {
            ...
            num = RR.Next(0, ClientSize.Width + ClientSize.Width + ClientSize.Width);
            ...
            for (int i = 0; i < Le.Count; i++)
            {
                if (num >= Le[i].XD - Le[i].imgld[0].Width -30 && num <= Le[i].XD + Le[i].imgld[0].Width + Le[i].imgld[0].Width)
                {
                    h++;
                }
        ...
        void Createbands()
        {
            ...
            if (z == 3)
            {
                ...
                bar pnn7 = new bar();
                pnn7.W = 200;
                pnn7.X = pnnn.XD+pnnn.img.Width/2-110;
                pnn7.H = ClientSize.Height * 1 / 100;
